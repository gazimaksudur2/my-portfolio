...
const MySkills = () => {
    ...
    return (
        <div id='skills' className='relative py-4 lg:py-10 flex flex-col justify-center items-center'>
            <ScrollRestoration/>
            <div className='space-y-2 flex flex-col justify-center items-center'>
                ...
                <h3 className='w-[90%] lg:w-[60%] text-sm text-center text-[#151515ab]'>My continuous learning mindset keeps me updated with the latest trends and technologies in web development, enabling me to deliver cutting-edge solutions.</h3>
            </div>
                    ...
                    skills.map((each, idx) => <>
                        <div className="w-44 lg:w-52 group text-center" key={idx}>
                            <div className="card-body bg-base-200 border-2 border-base-300 flex flex-col justify-center items-center rounded-md duration-100 hover:bg-purple-500 hover:border-purple-800 hover:text-white gap-3">
                                ...
                                <h2 className="card-title text-lg lg:text-xl">{each?.technology}</h2>
                            </div>
                        </div>
                    </>)
                }
            </div>
            <Link to={'#top'} className="absolute bottom-0 right-24 hidden lg:flex border-2 p-2 rounded-full text-purple-600 border-purple-600 cursor-pointer active:scale-95">
